...
CONFIG_BOOTARGS="console=ttyS1,115200 earlyprintk panic=5 rootwait root=/dev/mmcblk0p2 earlyprintk rw rootfstype=ext4"
...
CONFIG_BOOTCOMMAND="setenv bootm_boot_mode sec; load mmc 0:1 0x41000000 zImage; load mmc 0:1 0x41800000 retro-v3s.dtb; bootz 0x41000000 - 0x41800000;"
